...
A flatpak for [FnordLauncher](https://github.com/FnordMC/FnordLauncher)
...
2\. Open Fnord, click on the **Settings** button
...
### How do I run MC on a hybrid GPU system with a dedicated NVIDIA GPU using Fnord Launcher?
